...
export const backCardsContent = [
    ...
    },
    {
        ...
        backContent: <span className={styles.backCardContent}>Для вашего удобства мы предоставляем личного менеджера, который в любое время поможет решить поставленную задачу на высшем уровне!
</span>
    },
    {
        title: 'Работаем 24/7',
        backContent: <span className={styles.backCardContent}>Мы всегда на связи - поможем решить задачу любого масштаба точно в срок!
</span>
    },
    {
